      ...
      <Card className="shadow-lg border-0 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm transition-colors duration-300">
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2 transition-colors duration-300">No transactions yet</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-4 transition-colors duration-300">Start by adding your first transaction above.</p>
          </div>
        </CardContent>
      </Card>
    );
          ...
          <Table>
            <TableHeader className="bg-gray-50/50 dark:bg-gray-700/50 transition-colors duration-300">
              <TableRow>
                ...
                <TableHead className="font-semibold text-right text-gray-700 dark:text-gray-300">Amount</TableHead>
                <TableHead className="font-semibold text-center text-gray-700 dark:text-gray-300">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {transactions.map((transaction) => (
                <TableRow key={transaction.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-all duration-200 hover:scale-[1.01] hover:shadow-sm">
                  ...
                  <TableCell className="text-right font-semibold">
                    <span className={`transition-colors duration-200 ${transaction.amount > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                    ...
                    <div className="flex justify-center space-x-2">
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent className="dark:bg-gray-800 dark:border-gray-700">
                          <AlertDialogHeader>
                            <AlertDialogTitle className="dark:text-gray-100">Delete Transaction</AlertDialogTitle>
